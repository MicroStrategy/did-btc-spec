...
export type VerificationMethodOperation =
...
export type DidUpdateParams = BaseDidTransactionParams &
  DidUtxo & {
...
export type BatchDidUpdateParams = BaseDidTransactionParams &
  DidUtxo & {
...
export type BitcoinTransaction =
  ...
  | BitcoinTransactionWithChange;

/**
 * A type guard function that determines if a transaction has a change output.
 */
export function isBitcoinTransactionWithChange(
  tx: BitcoinTransactionNoChange,
): tx is BitcoinTransactionWithChange {
